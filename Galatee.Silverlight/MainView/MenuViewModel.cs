                            ...
                            menuItem.Name == "Galatee.Silverlight.Caisse.ListeEncaissementJournalière")
                        {
                           ...
                           || menuItem.Name == "Galatee.Silverlight.Caisse.FrmAnnulationEncaissement")
                            ...
                            cw = Activator.CreateInstance(cwType, new string[] { retourneTypeActionFacturation(menuItem.Title) });
                                 ...
                                 menuItem.Name == "Galatee.Silverlight.Report.FrmListeInteretMoratoire" ||
                    ...
                    case "400015":
                     ...
                     case "700013":
                      ...
                      case "8":
                        ...
                        break;
                      case "73":
                        _typeDemande = SessionObject.ListeInteretsMoratoireDus;
                        break;
                      case "74":
                        _typeDemande = SessionObject.ListeInteretsMoratoirePayés;
                        break;
                      case "75":
                        _typeDemande = SessionObject.ListeInteretsMoratoireAnnulés;
                        break;
