        ...
        public EnumereWrap returnEnumereWrapper()
        {
            try
            {
                ...
                EnumereWrap wrapEnumere = new EnumereWrap()
                {
                    ...
                    CoperIMO = Enumere.CoperIMO,
                    ListeInteretsMoratoireDus = Enumere.ListeInteretsMoratoireDus,
                    ListeInteretsMoratoirePayés = Enumere.ListeInteretsMoratoirePayés,
                    ListeInteretsMoratoireAnnulés = Enumere.ListeInteretsMoratoireAnnulés,
