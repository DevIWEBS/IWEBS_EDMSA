...
namespace WcfService
{
    ...
    public interface IReportService 
    {
        ...
        [OperationContract]
        [FaultContract(typeof(Errors))]
        List<CsLclient> RetourneListeDesInteretsMoratoire(List<int> lstCentre, List<int> lstCategorie, List<int> lstRegroupement, string PeriodeDebut, string periodefin, string etat);
