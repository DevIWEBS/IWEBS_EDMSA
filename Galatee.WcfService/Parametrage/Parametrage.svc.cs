...
namespace WcfService
{
    ...
    public class Parametrage : IParametrage
    {
        ...
        */
        ...
        public List<CsCategorieClient> GetCategoriesExemptionInteretMoratoire()
        {
            try
            {
                return new DB_ParametresGeneraux().ChargerListeExemtion();
            }
            catch (Exception ex)
            {
                ErrorManager.LogException(this, ex);
        ...
        public string TraiterExemptionInteretMoratoire(List<CsCategorieClient> lesCategories)
        {
            try
            {
                return new DB_ParametresGeneraux().TraiterExemptionCategorie(lesCategories);
            }
            catch (Exception ex)
            {
                ErrorManager.LogException(this, ex);
