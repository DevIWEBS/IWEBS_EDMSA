...
namespace WcfService
{
    ...
    public interface IFacturationService
    {
        ...
        [OperationContract]
        [FaultContract(typeof(Errors))]
        List<CsEnteteFacture> retourneFactureAnnulation(int idCentre, string centre, string client, string ordre, bool verifieExisteDemandeSurFacture);


        [OperationContract]
        [FaultContract(typeof(Errors))]
        List<CsLclient> retourneFactureAnnulationInteretMoratoire(int idCentre, string centre, string client, string ordre);
