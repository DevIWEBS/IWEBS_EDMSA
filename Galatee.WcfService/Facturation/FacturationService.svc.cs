...
namespace WcfService
{
    ...
    public class FacturationService : IFacturationService
    {
        ...
        public List<CsEnteteFacture> retourneFactureAnnulation(int idCentre, string centre, string client, string ordre, bool verifieExisteDemandeSurFacture)
        {
            try
            {
                DbFacturation db = new DbFacturation();
                //return db.ListeDesFacturesAnnulation(idCentre, centre, client, ordre, string.Empty, string.Empty); ZEG 04/01/2021
                return db.FacturesPourAnnulation(idCentre, centre, client, ordre, verifieExisteDemandeSurFacture);
            }
            catch (Exception ex)
            {
                ErrorManager.LogException(this, ex);
        ...
        public List<CsLclient> retourneFactureAnnulationInteretMoratoire(int idCentre, string centre, string client, string ordre)
        {
            try
            {
                DbFacturation db = new DbFacturation();
                return db.FacturesPourAnnulationIMO(idCentre, centre, client, ordre);
            }
            catch (Exception ex)
            {
                ErrorManager.LogException(this, ex);
