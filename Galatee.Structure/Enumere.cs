...
namespace Galatee.Structure
{
    public static class Enumere
    {
        ...
        public static string CoperIMO = "050"; //Interêt moratoire
        ...
        public static string ListeInteretsMoratoireDus = "73";
        public static string ListeInteretsMoratoirePayés = "74";
        public static string ListeInteretsMoratoireAnnulés = "75";
        ...
        public static string FactureInteretMoratoire = "15";
        public static string EncaissementInteretMoratoire = "16";
        #endregion
