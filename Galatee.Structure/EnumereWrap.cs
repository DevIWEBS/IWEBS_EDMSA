...
namespace Galatee.Structure
{
    ...
    public class EnumereWrap
    {
        ...
        // Coper
         ...
         [DataMember] public string CoperIMO { get; set; }
         ...
         [DataMember] public string ListeInteretsMoratoireDus { get; set; }
         [DataMember] public string ListeInteretsMoratoirePayés { get; set; }
         [DataMember] public string ListeInteretsMoratoireAnnulés { get; set; }
