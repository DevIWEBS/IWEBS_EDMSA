    ...
    public class DBMoratoires
    {
       ...
       public bool? SaveMandatementGcOpti(List<CsDetailCampagneGc> ListMandatementGc, bool IsAvisCerdit)
       {
           try
           {
               ...
               /* LKO le 26/02/2021 pour prendre en compte les campagnes sans mandatement */
               if (leMandatement == null || leMandatement.FK_IDCAMPAGNA == null || leMandatement.NUMEROMANDATEMENT == "0000000000000")
               {
